...
CREATE TABLE `penjualan`  (
  ...
  `nonota` varchar(25) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `tglnota` datetime NULL DEFAULT NULL,
...
INSERT INTO `piutangdetail` VALUES (54, 10, 955556.00, '2019-05-02', '', '2019-04-29 00:00:00.000000', 'KAS', 0.00, '2019-04-29');
INSERT INTO `piutangdetail` VALUES (55, 1, 1550000.00, '2019-05-01', '', '2019-04-29 00:00:00.000000', 'KAS', 0.00, '2019-04-29');
INSERT INTO `piutangdetail` VALUES (56, 9, 906667.00, '2019-05-01', '', '2019-04-29 00:00:00.000000', 'KAS', 0.00, '2019-04-29');
INSERT INTO `piutangdetail` VALUES (57, 2, 1550000.00, '2019-05-01', '', '2019-04-29 00:00:00.000000', 'KAS', 0.00, '2019-04-29');
...
CREATE TABLE `stok`  (
  ...
  `createdby` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `createdon` datetime NULL DEFAULT NULL,
  `cc` varchar(15) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;
...
-- Records of stok
-- ----------------------------
INSERT INTO `stok` VALUES (1, 'N-MAX', 'BLACK', '2017', NULL, 'admin', '2019-02-16 00:00:00.000000', NULL);
INSERT INTO `stok` VALUES (2, 'VIXION', 'MERAH', '2018', NULL, 'admin', '2019-04-01 00:00:00.000000', NULL);
...
-- ----------------------------
INSERT INTO `tabelstok` VALUES (1, 'NT0005', '2019-04-01', 1, 10, 0.00, NULL, NULL);
INSERT INTO `tabelstok` VALUES (2, 'NT0004', '2019-04-01', 2, 15, 0.00, NULL, NULL);
INSERT INTO `tabelstok` VALUES (3, '123', '2019-04-29', 1, 123, 0.00, '123', '123');
